export const spec = {
  ...
  info: {
    ...
    version: "0.1.0",
    description:
      "Privacy-first analytics API. No cookies, no fingerprinting, no PII.",
    contact: { email: "hello@counted.dev" },
    license: { name: "MIT" },
  },
  servers: [
    { url: "https://app.counted.dev/api/v0", description: "Production" },
    { url: "http://localhost:3000/api/v0", description: "Local" },
  ],
  tags: [
    { name: "Ingestion", description: "Send events from your app" },
    { name: "Projects", description: "Manage projects and keys" },
    { name: "Query", description: "Query event data" },
    { name: "Dashboards", description: "Manage dashboards" },
    { name: "Alerts", description: "Threshold-based notifications" },
  ],
  paths: {
    "/event": {
      post: {
        ...
        description:
          "Send one or more events. Accepts a single event object or an array of up to 50 events. Returns 202 immediately — events are buffered.",
        security: [{ projectKey: [] }],
        requestBody: {
          required: true,
          content: {
    ...
    "/projects/{id}/schema": {
      get: {
        ...
        description:
          "Returns event names, property keys, and system field values observed in this project. Used for building queries.",
        security: [{ session: [] }],
        parameters: [{ $ref: "#/components/parameters/ProjectId" }],
        responses: {
          "200": {
            ...
            "application/json": {
              schema: {
                ...
                properties: {
                  ...
                  query: { $ref: "#/components/schemas/InsightQuery" },
              ...
              schema: {
                ...
                properties: {
                  ...
                  metric: {
                    type: "string",
                    description:
                      '"count", "unique_sessions", or a custom property name for sum',
                  },
                  ...
                  slackWebhookUrl: { type: "string", format: "uri" },
                },
              },
            },
          },
    ...
    "/dashboard-data": {
      post: {
        ...
        responses: {
          "200": {
            description: "Dashboard data with resolved insights",
            content: {
              "application/json": {
                schema: {
                  type: "object",
        ...
        parameters: [
          {
            ...
            in: "query",
            schema: { type: "string", format: "uuid" },
            description: "Filter to a specific project. Can be repeated for multiple projects.",
          },
        ],
        responses: {
          "200": {
  ...
  components: {
    securitySchemes: {
      projectKey: {
        ...
        in: "header",
        name: "Project-Key",
        description: "Client key (ck_...) for event ingestion only",
      },
      session: {
        type: "apiKey",
        in: "cookie",
    ...
    schemas: {
      ...
      Alert: {
        ...
        properties: {
          ...
          name: { type: "string" },
          metric: { type: "string" },
          eventFilter: { type: "string", nullable: true },
          condition: { type: "string", enum: ["above", "below"] },
      ...
      Insight: {
        ...
        properties: {
          ...
          type: {
            type: "string",
            enum: ["metric", "timeseries", "breakdown", "funnel", "retention"],
          },
          title: { type: "string" },
          span: { type: "integer", enum: [1, 2, 3, 4] },
          data: { type: "object" },
          query: { $ref: "#/components/schemas/InsightQuery" },
        },
      },
        ...
        properties: {
          ...
          groupBy: {
            ...
            items: {
              type: "object",
              properties: {
                type: { type: "string", enum: ["property", "system", "time"] },
                key: { type: "string" },
              },
            },
          },
      ...
      ProjectSchema: {
        ...
        properties: {
          ...
          systemFields: {
            type: "object",
            properties: {
              osNames: { type: "array", items: { type: "string" } },
