...
export const POSTS: PostMeta[] = [
  ...
  {
    slug: "js-analytics-in-5-minutes",
  ...
  {
    slug: "preact-analytics-in-5-minutes",
    title: "Add product analytics to your Preact app in 5 minutes",
    description:
      "Drop @counted/sdk into any Preact + Vite app, auto-track page views on every route, and fire custom events — no cookies, under 3KB.",
    date: "2026-09-30",
    readingTime: "5 min",
    category: "Quickstart",
    published: true,
