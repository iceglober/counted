  ...
  return (
    <LegalPage title="Privacy Policy" updated="June 2, 2026">
      <P>
        ...
        &quot;us&quot;). Privacy isn&apos;t a setting here — it&apos;s the design. This policy
        explains what we collect, what we deliberately don&apos;t, and the choices you have.
      </P>
      ...
      <H2>Cookies</H2>
      <P>We use <strong>no cookies for analytics or tracking</strong>. The signed-in app uses a single strictly-necessary cookie to keep your session authenticated — it carries no tracking function and is required for the app to work. That is the only cookie Counted sets.</P>
