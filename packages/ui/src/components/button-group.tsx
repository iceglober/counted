...
function ButtonGroupText({
  ...
  return useRender({
    ...
    props: mergeProps<"div">(
      {
        className: cn(
          "flex items-center gap-2 border border-input bg-background px-2.5 text-xs font-semibold group-has-[>[data-variant=outline]]/button-group:border-border [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-3.5",
          className,
        ),
      },
      props,
