  ...
  return (
    <ChartContext.Provider value={{ config }}>
      ...
      >
        ...
        {/* Recharts measures inside a zero-width wrapper; never cap its SVG to that wrapper. */}
...
function ChartTooltipContent({
  ...
  return (
    <div
      className={cn(
        "grid min-w-32 items-start gap-1.5 bg-popover px-2.5 py-1.5 text-xs text-popover-foreground border border-border",
        className,
      )}
    >
