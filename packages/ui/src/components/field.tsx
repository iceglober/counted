...
function FieldGroup({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "group/field-group @container/field-group flex w-full flex-col gap-s-5 data-[slot=checkbox-group]:gap-3 *:data-[slot=field-group]:gap-4",
        className,
      )}
      {...props}
    />
...
const fieldVariants = cva(
  "group/field flex w-full gap-s-2 data-[invalid=true]:text-destructive",
  {
    variants: {
      orientation: {
...
function FieldTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      data-slot="field-label"
      className={cn(
        "flex w-fit items-center gap-2 text-xs font-medium group-data-[disabled=true]/field:opacity-50 in-data-[slot=field-label]:font-semibold",
        className,
      )}
      {...props}
    />
