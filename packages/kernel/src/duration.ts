 ...
 * belongs wherever the surrounding date is available — under v3 that is litics,
 * which owns bucketing.
 *
 * v1 got this wrong in a way worth remembering: it treated a month as a flat 30
 * days for previous-period trends, so every month-over-month comparison was off
 * by up to 3.3%.
 */
