...
export const PAYMENT_STATES: readonly PaymentState[] = ["none", "active", "past_due", "canceled"];

export const isPaymentState = (raw: string): raw is PaymentState =>
  (PAYMENT_STATES as readonly string[]).includes(raw);
...
export const Entitlement = {
  ...
  isPaid: (e: Entitlement): boolean => PlanCatalog.isPaid(e.plan),
  ...
  equal: (a: Entitlement, b: Entitlement): boolean =>
